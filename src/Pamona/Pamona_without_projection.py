...
from src.Pamona.utils import *
from src.Pamona.visualization import visualize
...
class Pamona(object):
	...
	def run_Pamona(self, data):
		...
		return self.Gc  # Geodesic correspondence matrices between each dataset and the last dataset (without virtual cells)
