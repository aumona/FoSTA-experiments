...
from utils.benchmark_utils import visualization, run_models_from_adata, run_our_models, run_metrics
...
parser.add_argument('--savename', default = "simulated_multimodal", type=str)
...
labels_masked = mask_labels_stratified(labels, label_mask_fraction, random_state=seed)
...
results_df.insert(0, "label_mask_fraction", label_mask_fraction)
