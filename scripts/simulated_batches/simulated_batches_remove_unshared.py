...
adata, mask_indices = global_label_masking(adata, masking_frac=0.2, label_key=label_key, batch_key=batch_key, random_state=seed) 
...
from utils.simulation_utils import remove_dataset_specific_cells
