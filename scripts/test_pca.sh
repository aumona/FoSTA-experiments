...
log_dir=/NOBACKUP/lizottem/fosta/logs/test_pca/$timestamp
...
python3 scripts/real_batches_lung/real_batches_lung.py --test --batch1 "A1" --batch2 "A2" --components 2  --globalmasking 0 --savename "real_batches_lung/with_pca"  > "$log_dir/"$batch1"_"$batch2"_1.out" 